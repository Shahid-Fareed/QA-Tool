...
import { Settings2, Check, X, Copy, Sparkles, User } from "lucide-react";
      ...
      <div className="flex flex-col gap-6 animate-fade-in-up w-full max-w-full">
        ...
        <div className="spatial-card rounded-2xl overflow-hidden border border-border/50 bg-surface/30">
          ...
          <div className="flex items-center px-8 py-4 bg-brand/3 border-b border-border/50 text-[10px] font-semibold uppercase tracking-widest text-foreground/40">
            ...
            <div className="w-48 text-center">Role</div>
            <div className="w-40 text-center">Permission</div>
              ...
              <div className="flex items-center px-8 py-6 bg-brand/5 animate-in slide-in-from-top-1 duration-300 border-b border-brand/20">
                ...
                <div className="flex-1 px-4">
                  <input
                    ...
                    className="w-full bg-surface border border-border/40 rounded-lg px-3 py-2 text-xs font-semibold text-foreground outline-none focus:ring-2 focus:ring-brand/10 focus:border-brand/40 shadow-sm"
                  />
                </div>

                {/* Role Select */}
                <div className="w-48 flex justify-center px-4">
                ...
                <div className="w-40 flex justify-center text-[10px] font-semibold text-foreground/20 uppercase">
                  Default Access
                </div>
            ...
            {filteredUsers.length === 0 && !isAdding ? (
              ...
              filteredUsers.map((user) => (
                ...
                >
                  ...
                  {/* Name Column */}
                  <div className="flex-1 px-4">
                    <span className="text-sm font-semibold text-foreground/90 tracking-tight font-sans">
                      {user.name}
                    </span>
                  </div>

                  {/* Email Column */}
                  <div className="flex-1 flex items-center justify-center gap-2 px-4 text-xs text-foreground/60 font-semibold tracking-tight">
                    <Mail className="w-3.5 h-3.5 opacity-40 text-brand" />
                    {user.email}
                  </div>

                  {/* Role Column with Inline Edit */}
